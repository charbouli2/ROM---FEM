function [ux,v,p,SNAP_cluster,SNAP] = SVDtotal_2(COOR_v,CN_v,rnod_v,dR_v,COOR_p,rnod_p,dR_p,K,G,res,...
...
%   - p: vector with the pressure
    ...
    icluster=1;
    SNAP.X = zeros(totDOF_l,steps); %% Edited : Changed the dimension (para calcular SVD de TODAS velocidades conocidas: Numero de grados de libertad restringido + libres)
    ...
    save("NACA_Total.mat", "SNAP", "SNAP_cluster");

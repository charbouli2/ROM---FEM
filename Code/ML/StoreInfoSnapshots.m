function [SNAP,DATA,icluster,SNAP_cluster] = StoreInfoSnapshots(istep,icluster,SNAP,VAR,DATA,CONVERGED,...
    COOR,CN,posgp,TypeElement,DOFl,NameFileMesh,SNAP_cluster)
